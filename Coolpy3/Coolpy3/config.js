module.exports = {
    ...
    rootUrl: 'http://100.64.166.92:1337',//微信公众号绑定域名，只须填写你的酷痞平台最终公网域名即可，即当公众号收到菜单指令后酷痞会命使此配置来生成定向回复消息
    wechatPort: 80,//微信功能端口，默认80，微信目前只支持80端口，路由器运行酷痞由于80端口已被路由器占用所以不能使用此功能，如用其他端口请使用反向代理工具
